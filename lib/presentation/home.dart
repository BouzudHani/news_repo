        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              Obx(
                () => searchController.isFirstLoading.value
                    ? const Center(
              ...
              if (searchController.firstNewsResults.isNotEmpty) const Divider(),
              if (searchController.isSecondLoading.value)
                Obx(() => const CircularProgressIndicator()),
